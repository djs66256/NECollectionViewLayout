...
#import "NEScrollDirectionCollectionViewController.h"

@interface NEScrollDirectionCollectionViewController () <NECollectionViewDelegateFlowLayout>

@property (nonatomic, assign) NSInteger sections;

@end

@implementation NEScrollDirectionCollectionViewController
...
- (void)deleteSection {
    self.sections --;
    [self.collectionView deleteSections:[NSIndexSet indexSetWithIndex:self.sections]];
}
...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"delete" style:UIBarButtonItemStylePlain target:self action:@selector(deleteSection)];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    return  CGSizeMake(collectionView.frame.size.width / 5, indexPath.item % 3 ? 44 : 88);
}
...
#pragma mark - Scroll direction delegate & page enable & page size
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)layout pageSizeForSectionAtIndex:(NSInteger)section {
    return CGSizeMake(collectionView.frame.size.width * 0.8, 1);
}
